...
/*選單hover效果動畫*/
	$(document).ready(function(e) {
        ...
        $(this).toggleClass("active");
            ...
            setTimeout(function(){
                    $(".menu_content .link1").eq(8).addClass("active");
                    setTimeout(function(){
                    	$(".menu_content .link1").eq(8).find('img').addClass("bounceIn animated").removeClass("bounceOut");
                    }, 800);
            }, 2100);
			
			setTimeout(function(){
                    $(".menu_content .link1").eq(9).addClass("active");
                    setTimeout(function(){
                    	$(".menu_content .link1").eq(9).find('img').addClass("bounceIn animated").removeClass("bounceOut");
                    }, 800);
            }, 2300);
			
			setTimeout(function(){
                    $(".menu_content .link1").eq(10).addClass("active");
                    setTimeout(function(){
                    	$(".menu_content .link1").eq(10).find('img').addClass("bounceIn animated").removeClass("bounceOut");
                    }, 800);
            }, 2500);
			
			setTimeout(function(){
                    $(".menu_content .link1").eq(11).addClass("active");
                    setTimeout(function(){
                    	$(".menu_content .link1").eq(11).find('img').addClass("bounceIn animated").removeClass("bounceOut");
                    }, 800);
            }, 2700);
	...
	function(){
	 ...
	 function(){
		...
		$(".menu_hover").each(function(){  
				...
				var menu_icon_h = _this.find(".menu_icon_h");
